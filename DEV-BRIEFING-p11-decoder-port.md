...
1. `dotnet test -c Release` passes with `Failed: 0` — specifically, all three G6 fixture tests must go **green** (i.e. the decoder recovers `UK8OM K2ZJ FN13`, `EA6LU F4MGP JN04`, etc. from the committed WAVs).
