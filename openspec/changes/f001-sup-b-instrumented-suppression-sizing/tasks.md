...
- [ ] 3.3 macOS ARM64 — NOT rebuilt locally (no Mac available), same limitation every prior native
      change in this project has recorded. CI rebuilds it from source on the eventual push.
...
- [ ] 17.1 Once Phase 2 lands and this change is ready to archive, merge this change's
...
- [ ] 17.2 Merge this change's `specs/ft8lib-interop/spec.md` delta into
...
- [ ] 17.3 `openspec validate --strict --all` passes after both merges.

## 18. Housekeeping

- [ ] 18.1 Update `MEMORY.md`/`BOARD.md` to record this change's opening (the retrofit itself,
...
- [ ] 18.2 Once this change is fully landed and archived (`opsx:archive`), confirm the archived
