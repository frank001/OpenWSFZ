...
- **THEN** it SHALL contain `audioDeviceId: null`, `audioDeviceFriendlyName: null`, and `port: 8080` at minimum, and the daemon SHALL start successfully using those values
