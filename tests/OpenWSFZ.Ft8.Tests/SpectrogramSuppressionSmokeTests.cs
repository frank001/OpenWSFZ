...
/// path (H4 accepted baseline, diag-d001-h4-spectrogram-reinstate, shim 20260010).
///
/// <para>
...
/// the answer key is decoded, with the suppression ramp at [−5, +15] dB
/// (25% suppression at 0 dB SNR — H4 accepted baseline, S7 56.99%).
/// </para>
///
/// <para>
/// This test is the spectrogram-suppression smoke-gate: it runs against the native binary
/// at shim version 20260010, with <c>Ft8LibInterop.ExpectedShimVersion</c> set to
/// <c>20260010</c>.
/// </para>
///
/// <para>
...
{
    [Fact(DisplayName = "H4 smoke: Ft8Decoder.DecodeAsync with synth-qso-01 returns expected results (shim 20260010 suppression ramp [−5, +15])")]
    public async Task DecodeAsync_SynthQso01_ReturnsExpectedResults_SpectrogramSuppression()
    {
        ...
        results.Should().NotBeEmpty(
            "the spectrogram suppression path (shim 20260010, ramp [−5, +15]) must produce at least one decoded " +
