...
public sealed class Ft8DecoderPlausibilityTests
{
    ...
    [InlineData("Q1AW Q1ABC FN31",   "standard grid")]
    [InlineData("Q1AW Q1ABC AA00",   "minimum Maidenhead grid")]
    [InlineData("Q1AW Q1ABC RR99",   "maximum valid Maidenhead grid (R=17)")]
    [InlineData("Q1AW Q1ABC -15",    "negative dB report")]
    [InlineData("Q1AW Q1ABC +05",    "positive dB report")]
    [InlineData("Q1AW Q1ABC -30",    "minimum dB report")]
    [InlineData("Q1AW Q1ABC +49",    "near-maximum dB report")]
    [InlineData("Q1AW Q1ABC R-12",   "received dB report with R prefix")]
    [InlineData("Q1AW Q1ABC R+05",   "received positive dB report")]
    [InlineData("Q1AW Q1ABC RRR",    "terminal RRR")]
    [InlineData("Q1AW Q1ABC 73",     "terminal 73")]
    [InlineData("Q1AW Q1ABC RR73",   "terminal RR73")]
    ...
    [InlineData("CQ Q1AW FN31",      "standard CQ")]
    [InlineData("CQ DX Q1AW FN31",   "CQ DX — 4 tokens, accepted unconditionally")]
    [InlineData("CQ NA Q1AW FN31",   "CQ NA — 4 tokens, accepted unconditionally")]
    ...
    [InlineData("Q1AW Q1ABC <XYZ>",  "Type 4 hash notation in last token")]
    [InlineData("Q1AW <XYZ>",        "2-token message — accepted unconditionally")]
    [InlineData("CQ Q1AW FN31 NA",   "4-token message — accepted unconditionally")]
    [InlineData("DE Q1AW",           "2-token message")]
    ...
    [InlineData("Q1AW Q1ABC 00000",  "contest serial zero")]
    [InlineData("Q1AW Q1ABC 12345",  "typical contest serial")]
    [InlineData("Q1AW Q1ABC 97799",  "maximum contest serial")]
    ...
    [InlineData("Q1AW Q1ABC SN31",   "first letter 'S' > 'R' (index 18 > 17)")]
    [InlineData("Q1AW Q1ABC TN31",   "first letter 'T' > 'R' (index 19 > 17)")]
    [InlineData("Q1AW Q1ABC ZA99",   "first letter 'Z' > 'R' (index 25 > 17)")]
    [InlineData("Q1AW Q1ABC AS31",   "second letter 'S' > 'R' (index 18 > 17)")]
    [InlineData("Q1AW Q1ABC XY99",   "both letters 'X','Y' > 'R'")]
    [InlineData("Q1AW Q1ABC ZZ00",   "both letters 'Z','Z' > 'R' — maximum impossible grid")]
