#!/usr/bin/env python3
"""NFR-021 redaction pass -- full S1-S8 sweep, results/2026-09-13-4584900-3/.
...
This is sweep 4 of the Captain-directed six-sweep routine batch, same HEAD (`4584900d`) as
sweeps 1-3. Run directory renamed from the harness's natural `2026-09-13-4584900` to
`2026-09-13-4584900-3` (sweeps 2 and 3 already committed `2026-09-13-4584900` and `-2` on their
own branches).

Usage:
    python redact_s1s8_20260913c_decodes.py
"""
...
_RUN_DIR = _HERE / "results" / "2026-09-13-4584900-3"
...
def main() -> int:
    ...
    map_lines = [
        ...
        "(see `redact_s1s8_20260913c_decodes.py`'s guard step) -- none appear inside any "
        ...
        "own infix. Deliberately NOT Q-prefix, for the same reason as the other maps.",
        "",
