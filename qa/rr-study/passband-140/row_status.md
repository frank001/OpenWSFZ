...
|---|---|---|---|
| **0a** build | pending | — | needs `WIDE`'s SHA; `BASE` half already covered by 0b below |
...
- `WIDE`: pending Developer build (Amendment 1 edit: `.f_min = 140.0f, .f_max = 3075.0f,` at `ft8_shim.c:1472`/`:1872`).
