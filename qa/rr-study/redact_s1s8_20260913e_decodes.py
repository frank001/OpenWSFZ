#!/usr/bin/env python3
"""NFR-021 redaction pass -- full S1-S8 sweep, results/2026-09-13-4584900-5/.
...
This is sweep 6 (final) of the Captain-directed six-sweep routine batch, same HEAD (`4584900d`)
as sweeps 1-5. Run directory renamed from the harness's natural `2026-09-13-4584900` to
`2026-09-13-4584900-5` (sweeps 2/3/4/5 already committed the bare path, `-2`, `-3`, `-4`).

Usage:
    python redact_s1s8_20260913e_decodes.py
"""
...
_RUN_DIR = _HERE / "results" / "2026-09-13-4584900-5"
...
def main() -> int:
    ...
    map_lines = [
        ...
        "(see `redact_s1s8_20260913e_decodes.py`'s guard step) -- none appear inside any "
