#!/usr/bin/env python3
"""NFR-021 redaction pass -- full S1-S8 sweep, results/2026-09-13-4584900-4/.
...
This is sweep 5 of the Captain-directed six-sweep routine batch, same HEAD (`4584900d`) as
sweeps 1-4. Run directory renamed from the harness's natural `2026-09-13-4584900` to
`2026-09-13-4584900-4` (sweeps 2/3/4 already committed the bare path, `-2`, `-3`).

Usage:
    python redact_s1s8_20260913d_decodes.py
"""
...
_RUN_DIR = _HERE / "results" / "2026-09-13-4584900-4"
...
def main() -> int:
    ...
    map_lines = [
        ...
        "(see `redact_s1s8_20260913d_decodes.py`'s guard step) -- none appear inside any "
