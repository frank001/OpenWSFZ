...
|---|---|
| Run date | 2026-06-07 |
| OpenWSFZ SHA | `497996f333c6892d76d91e78a8b2fd48332aa561` |
...
|---|---|---|
| Repeatability | 0.12 | 0.12% |
| Reproducibility | 6.18 | 6.46% |
| Part-to-Part | 89.47 | 93.42% |
| Total GR&R | 6.30 | 6.58% |
| Total | 95.77 | 100.00% |
...
|---|---|---|
| %Tolerance (GR&R) | 150.60% | PASS |
| %Study Var (GR&R) | 25.65% | — |
| ndc | 5 | PASS |
...
|---|---|---|---|---|---|
| WSJT-X | -1.70 | -0.007 | -1.689 | 0.010 | PASS |
| OpenWSFZ | +1.63 | 0.094 | 1.493 | 0.782 | PASS |
...
| Component | σ² | %Contribution |
|---|---|---|
| Repeatability | 0.03 | 4.13% |
| Reproducibility | 0.02 | 3.03% |
| Part-to-Part | 0.68 | 92.84% |
| Total GR&R | 0.05 | 7.16% |
| Total | 0.73 | 100.00% |
...
| Metric | Value | Verdict |
|---|---|---|
| %Tolerance (GR&R) | 342.91% | PASS |
| %Study Var (GR&R) | 26.75% | — |
| ndc | 5 | PASS |
...
| P2 | -18.00 | 1/3 | 33.33% | 2/3 | 66.67% |
| P3 | -15.00 | 3/3 | 100.00% | 3/3 | 100.00% |

**Overall decode rate — WSJT-X: 33.33%  OpenWSFZ: 41.67%**
...
**Between-app per-signal agreement:** 65.59%
...
| P5 | near_collision | delta 12 Hz | 4/6 | 5/6 |
...
| P12 | capture | co-freq, 0 / -6 dB | 5/6 | 3/6 |
...
| SNR bias | S1/OpenWSFZ | +1.63 dB | PASS |
