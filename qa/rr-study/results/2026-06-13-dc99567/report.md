...
| near_collision | 86.67% | 76.67% |
| time_freq | 100.00% | 11.11% |
| **all** | **72.04%** | **43.01%** |
...
**Between-app per-signal agreement:** 60.22%
...
| P4 | near_collision | delta 6 Hz | 4/6 | 0/6 |
...
| P10 | time_freq | co-freq, dt 0.0 / 2.0 s | 6/6 | 2/6 |
