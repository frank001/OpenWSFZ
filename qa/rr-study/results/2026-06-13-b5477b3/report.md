...
|---|---|---|
| capture | 75.00% | 54.17% |
| co_channel | 47.62% | 4.76% |
| near_collision | 93.33% | 83.33% |
| time_freq | 100.00% | 22.22% |
| **all** | **79.57%** | **46.24%** |
...
| P1 | co_channel | 2-stack, equal -5 dB | 5/6 | 1/6 |
| P2 | co_channel | 3-stack, equal 0 dB | 0/9 | 0/9 |
| P3 | near_collision | delta 3 Hz | 6/6 | 6/6 |
| P4 | near_collision | delta 6 Hz | 4/6 | 3/6 |
| P5 | near_collision | delta 12 Hz | 6/6 | 4/6 |
...
| P11 | capture | co-freq, 0 / -3 dB | 5/6 | 4/6 |
